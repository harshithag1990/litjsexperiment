...
* Copyright 2017 Google LLC
* SPDX-License-Identifier: BSD-3-Clause
*/const Je={attribute:!0,type:String,converter:ut,reflect:!1,hasChanged:St},Fe=(s=Je,e,i)=>{const{kind:o,metadata:h}=i;let d=globalThis.litPropertyMetadata.get(h);if(d===void 0&&globalThis.litPropertyMetadata.set(h,d=new Map),o==="setter"&&((s=Object.create(s)).wrapped=!0),d.set(i.name,s),o==="accessor"){const{name:p}=i;return{set(A){const $=e.get.call(this);e.set.call(this,A),this.requestUpdate(p,$,s)},init(A){return A!==void 0&&this.C(p,void 0,s,A),A}}}if(o==="setter"){const{name:p}=i;return function(A){const $=this[p];e.call(this,A),this.requestUpdate(p,$,s)}}throw Error("Unsupported decorator location: "+o)};function _t(s){return(e,i)=>typeof i=="object"?Fe(s,e,i):((o,h,d)=>{const p=h.hasOwnProperty(d);return h.constructor.createProperty(d,o),p?Object.getOwnPropertyDescriptor(h,d):void 0})(s,e,i)}var Ke=Object.defineProperty,Ze=Object.getOwnPropertyDescriptor,ht=(s,e,i,o)=>{for(var h=o>1?void 0:o?Ze(e,i):e,d=s.length-1,p;d>=0;d--)(p=s[d])&&(h=(o?p(e,i,h):p(h))||h);return o&&h&&Ke(e,i,h),h};l.ListWidget=class extends B{constructor(){super(...arguments),this.headerIcon="",this.headerTitle="",this.sections=[],this.metadataLabel=""}render(){return U`
    ...
    `}renderSection(s){return U`
      <div class="section">
        ${s.title?U`<h3 class="section-title">${s.title}</h3>`:""}
        <div class="items-list">
          ${s.items.map(e=>this.renderItem(e))}
        </div>
      </div>
    `}renderItem(s){return U`
      <div class="item">
        <img 
          src=${s.avatar} 
          alt=${s.name}
  ...
  `,ht([_t()],l.ListWidget.prototype,"headerIcon",2),ht([_t()],l.ListWidget.prototype,"headerTitle",2),ht([_t({type:Array})],l.ListWidget.prototype,"sections",2),ht([_t()],l.ListWidget.prototype,"metadataLabel",2),l.ListWidget=ht([Ve("list-widget")],l.ListWidget),typeof globalThis<"u"&&(globalThis.MyElement=globalThis.MyElement||{},globalThis.MyElement.LitElement=B),l.LitElement=B,Object.defineProperty(l,Symbol.toStringTag,{value:"Module"})}));var xe=Object.getOwnPropertyDescriptor,Ue=(l,t,n,r)=>{for(var a=r>1?void 0:r?xe(t,n):t,c=l.length-1,u;c>=0;c--)(u=l[c])&&(a=u(a)||a);return a};C.UpcomingBirthdaysWidget=class extends j{constructor(){super(...arguments),this.sections=[{title:"This Month (July)",items:[{avatar:"https://i.pravatar.cc/150?img=1",name:"Diana Smith",metadata:"July 5th"},{avatar:"https://i.pravatar.cc/150?img=2",name:"Ethan Hunt",metadata:"July 8th"}]},{title:"Next Month (August)",items:[{avatar:"https://i.pravatar.cc/150?img=3",name:"Fiona Green",metadata:"August 1st"},{avatar:"https://i.pravatar.cc/150?img=4",name:"Gary Oldman",metadata:"August 10th"}]}]}render(){return me`
      <list-widget
        headerIcon="🎁"
      ...
      ></list-widget>
    `}},C.UpcomingBirthdaysWidget=Ue([Pe("upcoming-birthdays-widget")],C.UpcomingBirthdaysWidget),typeof globalThis<"u"&&(globalThis.MyElement=globalThis.MyElement||{},globalThis.MyElement.LitElement=j),C.LitElement=j,Object.defineProperty(C,Symbol.toStringTag,{value:"Module"})}));
