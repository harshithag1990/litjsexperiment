 ...
 */
const H = globalThis, z = H.ShadowRoot && (H.ShadyCSS === void 0 || H.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, D = Symbol(), V = /* @__PURE__ */ new WeakMap();
let et = class {
  constructor(t, e, s) {
...
const ht = (r) => new et(typeof r == "string" ? r : r + "", void 0, D), lt = (r, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: ct, defineProperty: dt, getOwnPropertyDescriptor: pt, getOwnPropertyNames: ut, getOwnPropertySymbols: $t, getPrototypeOf: ft } = Object, R = globalThis, J = R.trustedTypes, _t = J ? J.emptyScript : "", gt = R.reactiveElementPolyfillSupport, S = (r, t) => r, T = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? _t : null;
      break;
  ...
  return e;
} }, L = (r, t) => !ct(r, t), K = { attribute: !0, type: String, converter: T, reflect: !1, useDefault: !1, hasChanged: L };
...
A.elementStyles = [], A.shadowRootOptions = { mode: "open" }, A[S("elementProperties")] = /* @__PURE__ */ new Map(), A[S("finalized")] = /* @__PURE__ */ new Map(), gt?.({ ReactiveElement: A }), (R.reactiveElementVersions ??= []).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const I = globalThis, N = I.trustedTypes, Z = N ? N.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, st = "$lit$", f = `lit$${Math.random().toFixed(9).slice(2)}$`, it = "?" + f, mt = `<${it}>`, m = document, x = () => m.createComment(""), C = (r) => r === null || typeof r != "object" && typeof r != "function", B = Array.isArray, yt = (r) => B(r) || typeof r?.[Symbol.iterator] == "function", k = `[ 	
\f\r]`, E = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, G = /-->/g, Q = />/g, _ = RegExp(`>|${k}(?:([^\\s"'>=/]+)(${k}*=${k}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), X = /'/g, Y = /"/g, rt = /^(?:script|style|textarea|title)$/i, At = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), y = At(1), v = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), tt = /* @__PURE__ */ new WeakMap(), g = m.createTreeWalker(m, 129);
function nt(r, t) {
...
const vt = (r, t) => {
  ...
  for (let l = 0; l < e; l++) {
    const h = r[l];
    let c, p, a = -1, u = 0;
    for (; u < h.length && (o.lastIndex = u, p = o.exec(h), p !== null); ) u = o.lastIndex, o === E ? p[1] === "!--" ? o = G : p[1] !== void 0 ? o = Q : p[2] !== void 0 ? (rt.test(p[2]) && (i = RegExp("</" + p[2], "g")), o = _) : p[3] !== void 0 && (o = _) : o === _ ? p[0] === ">" ? (o = i ?? E, a = -1) : p[1] === void 0 ? a = -2 : (a = o.lastIndex - p[2].length, c = p[1], o = p[3] === void 0 ? _ : p[3] === '"' ? Y : X) : o === Y || o === X ? o = _ : o === G || o === Q ? o = E : (o = _, i = void 0);
    const $ = o === _ && r[l + 1].startsWith("/>") ? " " : "";
    n += o === E ? h + mt : a >= 0 ? (s.push(c), h.slice(0, a) + st + h.slice(a) + f + $) : h + f + (a === -2 ? l : $);
  }
    ...
    for (; (i = g.nextNode()) !== null && h.length < l; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const a of i.getAttributeNames()) if (a.endsWith(st)) {
          ...
          h.push({ type: 1, index: n, name: M[2], strings: $, ctor: M[1] === "." ? Et : M[1] === "?" ? St : M[1] === "@" ? wt : j }), i.removeAttribute(a);
...
class bt {
  ...
  u(t) {
    ...
    for (; h !== void 0; ) {
      if (o === h.index) {
        let c;
        h.type === 2 ? c = new O(n, n.nextSibling, this, t) : h.type === 1 ? c = new h.ctor(n, h.name, h.strings, this, t) : h.type === 6 && (c = new xt(n, this, t)), this._$AV.push(c), h = s[++l];
      }
...
class O {
  ...
  _$AI(t, e = this) {
    t = b(this, t, e), C(t) ? t === d || t == null || t === "" ? (this._$AH !== d && this._$AR(), this._$AH = d) : t !== this._$AH && t !== v && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : yt(t) ? this.k(t) : this._(t);
  }
  O(t) {
...
class j {
  ...
  _$AI(t, e = this, s, i) {
    ...
    let o = !1;
    if (n === void 0) t = b(this, t, e, 0), o = !C(t) || t !== this._$AH && t !== v, o && (this._$AH = t);
    else {
      const l = t;
      let h, c;
      for (t = n[0], h = 0; h < n.length - 1; h++) c = b(this, l[s + h], e, h), c === v && (c = this._$AH[h]), o ||= !C(c) || c !== this._$AH[h], c === d ? t = d : t !== d && (t += (c ?? "") + n[h + 1]), this._$AH[h] = c;
    }
    o && !i && this.j(t);
  }
  j(t) {
...
Ct?.(P, O), (I.litHtmlVersions ??= []).push("3.3.1");
const Pt = (r, t, e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Mt = { attribute: !0, type: String, converter: T, reflect: !1, hasChanged: L }, Ht = (r = Mt, t, e) => {
...
var Tt = Object.defineProperty, Nt = Object.getOwnPropertyDescriptor, q = (r, t, e, s) => {
...
let U = class extends w {
  ...
  render() {
    return !this.fields || this.fields.length === 0 ? y`` : y`
  ...
  getIconContent(r) {
    return r.icon ? y`<span class="icon-emoji">${r.icon}</span>` : r.iconUrl ? y`<img src="${r.iconUrl}" alt="${r.label}" class="icon-image" />` : y``;
  }
};
U.styles = lt`
    :host {
...
q([
  ot({ type: Array })
], U.prototype, "fields", 2);
q([
  ot({ type: Number })
], U.prototype, "columns", 2);
U = q([
  Ot("field-list-widget")
], U);
export {
  U as FieldListWidget
};
