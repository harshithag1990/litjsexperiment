 ...
 */
const M = globalThis, L = M.ShadowRoot && (M.ShadyCSS === void 0 || M.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, k = Symbol(), V = /* @__PURE__ */ new WeakMap();
let st = class {
  constructor(t, e, s) {
...
const at = (r) => new st(typeof r == "string" ? r : r + "", void 0, k), ht = (r, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: ct, defineProperty: dt, getOwnPropertyDescriptor: pt, getOwnPropertyNames: ut, getOwnPropertySymbols: $t, getPrototypeOf: ft } = Object, R = globalThis, G = R.trustedTypes, _t = G ? G.emptyScript : "", mt = R.reactiveElementPolyfillSupport, w = (r, t) => r, N = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? _t : null;
      break;
  ...
  return e;
} }, I = (r, t) => !ct(r, t), J = { attribute: !0, type: String, converter: N, reflect: !1, useDefault: !1, hasChanged: I };
...
A.elementStyles = [], A.shadowRootOptions = { mode: "open" }, A[w("elementProperties")] = /* @__PURE__ */ new Map(), A[w("finalized")] = /* @__PURE__ */ new Map(), mt?.({ ReactiveElement: A }), (R.reactiveElementVersions ??= []).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const B = globalThis, H = B.trustedTypes, K = H ? H.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, it = "$lit$", f = `lit$${Math.random().toFixed(9).slice(2)}$`, rt = "?" + f, gt = `<${rt}>`, g = document, C = () => g.createComment(""), P = (r) => r === null || typeof r != "object" && typeof r != "function", W = Array.isArray, yt = (r) => W(r) || typeof r?.[Symbol.iterator] == "function", D = `[ 	
\f\r]`, S = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, X = /-->/g, Y = />/g, _ = RegExp(`>|${D}(?:([^\\s"'>=/]+)(${D}*=${D}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Z = /'/g, Q = /"/g, nt = /^(?:script|style|textarea|title)$/i, At = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), tt = At(1), E = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), et = /* @__PURE__ */ new WeakMap(), m = g.createTreeWalker(g, 129);
function ot(r, t) {
...
const vt = (r, t) => {
  ...
  for (let h = 0; h < e; h++) {
    const a = r[h];
    let c, p, l = -1, u = 0;
    for (; u < a.length && (o.lastIndex = u, p = o.exec(a), p !== null); ) u = o.lastIndex, o === S ? p[1] === "!--" ? o = X : p[1] !== void 0 ? o = Y : p[2] !== void 0 ? (nt.test(p[2]) && (i = RegExp("</" + p[2], "g")), o = _) : p[3] !== void 0 && (o = _) : o === _ ? p[0] === ">" ? (o = i ?? S, l = -1) : p[1] === void 0 ? l = -2 : (l = o.lastIndex - p[2].length, c = p[1], o = p[3] === void 0 ? _ : p[3] === '"' ? Q : Z) : o === Q || o === Z ? o = _ : o === X || o === Y ? o = S : (o = _, i = void 0);
    const $ = o === _ && r[h + 1].startsWith("/>") ? " " : "";
    n += o === S ? a + gt : l >= 0 ? (s.push(c), a.slice(0, l) + it + a.slice(l) + f + $) : a + f + (l === -2 ? h : $);
  }
    ...
    for (; (i = m.nextNode()) !== null && a.length < h; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const l of i.getAttributeNames()) if (l.endsWith(it)) {
          ...
          a.push({ type: 1, index: n, name: O[2], strings: $, ctor: O[1] === "." ? bt : O[1] === "?" ? St : O[1] === "@" ? wt : z }), i.removeAttribute(l);
...
class U {
  ...
  _$AI(t, e = this) {
    t = b(this, t, e), P(t) ? t === d || t == null || t === "" ? (this._$AH !== d && this._$AR(), this._$AH = d) : t !== this._$AH && t !== E && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : yt(t) ? this.k(t) : this._(t);
  }
  O(t) {
...
class z {
  ...
  _$AI(t, e = this, s, i) {
    ...
    let o = !1;
    if (n === void 0) t = b(this, t, e, 0), o = !P(t) || t !== this._$AH && t !== E, o && (this._$AH = t);
    else {
      const h = t;
      let a, c;
      for (t = n[0], a = 0; a < n.length - 1; a++) c = b(this, h[s + a], e, a), c === E && (c = this._$AH[a]), o ||= !P(c) || c !== this._$AH[a], c === d ? t = d : t !== d && (t += (c ?? "") + n[a + 1]), this._$AH[a] = c;
    }
    o && !i && this.j(t);
  }
  j(t) {
...
Pt?.(x, U), (B.litHtmlVersions ??= []).push("3.3.1");
const xt = (r, t, e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ot = { attribute: !0, type: String, converter: N, reflect: !1, hasChanged: I }, Mt = (r = Ot, t, e) => {
...
var Nt = Object.defineProperty, Ht = Object.getOwnPropertyDescriptor, T = (r, t, e, s) => {
...
let y = class extends v {
  ...
  render() {
    return this.image && this.image.trim() !== "" ? tt`
        <img 
          class="avatar" 
          src="${this.image}" 
          alt="${this.name}" 
...
T([
  j({ type: String })
], y.prototype, "firstName", 2);
T([
  j({ type: String })
], y.prototype, "lastName", 2);
y = T([
  Tt("user-avatar")
], y);
