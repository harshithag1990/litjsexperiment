...
const { is: R, defineProperty: x, getOwnPropertyDescriptor: j, getOwnPropertyNames: z, getOwnPropertySymbols: k, getPrototypeOf: T } = Object, u = globalThis, E = u.trustedTypes, D = E ? E.emptyScript : "", L = u.reactiveElementPolyfillSupport, c = (i, t) => i, p = { toAttribute(i, t) {
  ...
  return e;
} }, y = (i, t) => !R(i, t), b = { attribute: !0, type: String, converter: p, reflect: !1, useDefault: !1, hasChanged: y };
...
class h extends HTMLElement {
  ...
  requestUpdate(t, e, s) {
    if (t !== void 0) {
      ...
      if (s ??= r.getPropertyOptions(t), !((s.hasChanged ?? y)(o, e) || s.useDefault && s.reflect && o === this._$Ej?.get(t) && !this.hasAttribute(r._$Eu(t, s)))) return;
      this.C(t, e, s);
    }
...
h.elementStyles = [], h.shadowRootOptions = { mode: "open" }, h[c("elementProperties")] = /* @__PURE__ */ new Map(), h[c("finalized")] = /* @__PURE__ */ new Map(), L?.({ ReactiveElement: h }), (u.reactiveElementVersions ??= []).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
const q = { attribute: !0, type: String, converter: p, reflect: !1, hasChanged: y }, N = (i = q, t, e) => {
  ...
  if (o === void 0 && globalThis.litPropertyMetadata.set(r, o = /* @__PURE__ */ new Map()), s === "setter" && ((i = Object.create(i)).wrapped = !0), o.set(e.name, i), s === "accessor") {
    ...
    return { set(a) {
      ...
      t.set.call(this, a), this.requestUpdate(n, f, i);
    }, init(a) {
  ...
  if (s === "setter") {
    ...
    return function(a) {
      const f = this[n];
      t.call(this, a), this.requestUpdate(n, f, i);
    };
  }
